...
Route::post('/posts/view/', [App\Http\Controllers\ResumeController::class, 'upload'])->name('storeresume');

Route::get('/posts/view/', [App\Http\Controllers\ResumeController::class, 'download'])->name('downloadresume');
